...
def send_feedback_email(name, email, rating, product_used, duration, feedback_text, suggestions, specific_ratings, nps, contact_permission):
    try:
        ...
        SENDER_EMAIL = "prithwirajcharchigcsj@gmail.com"  # Replace with your actual email
        SENDER_PASSWORD = "dadk eszt ctgp vcxh"  # Replace with your app password or email password
        RECIPIENT_EMAIL = "prithwirajcharchigcsj@gmail.com"  # Replace with where you want to receive feedback (can be same as sender)
...
with st.sidebar:
    ...
    st.write("Email us: support@example.com")
    st.write("Call us: +1 (555) 123-4567")